...
function ShowTakeBillingItemsOnPageLoad(TokenNo) {
    ...
    xmlhttp.open("POST", "/TakeAway/_getTakeAwayBillingItemOnPageLoad", true);
    xmlhttp.send(data);
...
function showSubItem(str) {
    ...
    xmlhttp.open("GET", "/TakeAway/_GetAllSubItemPartial?Id=" + str, true);
    xmlhttp.send();
}
...
function ShowTakeBillingItemsOnItem(str, TokenNo, Qty, Type) {
    ...
    xmlhttp.open("POST", "/TakeAway/_GetTakeAwayBillingItems", true);
    xmlhttp.send(data);
...
function DeleteItem(str) {
    ...
    xmlhttp.open("GET", "/TakeAway/_DeleteItem?Id=" + str, true);
    xmlhttp.send();
}
...
function ReturnItem(str) {
    ...
    xmlhttp.open("GET", "/TakeAway/_ReturnItem?Id=" + str, true);
    xmlhttp.send();
}
...
function ClearKot() {
    ...
    xmlhttp.open("GET", "/TakeAway/_clearKOT", true);
    xmlhttp.send();
}
...
function CancelOrder() {
    ...
    xmlhttp.open("GET", "/TakeAway/CancelOrder", true);
    xmlhttp.send();
}
...
$(document).on('click', '#_bill_print', function (e) {
    ...
    centeredPopup("/TakeAway/_printData?TableNo=" + RunningTable + "&Discount=" + Discount + "&VatAmount=" + VatAmount + "&ServiceCharge=" + ServiceCharge + "&DiscountAmount=" + DiscountAmount + "&TotalAmount=" + TotalAmount + "&NetAmount=" + NetAmount + "&CustomerName=" + CustomerName, 'myWindow', '600', '400', 'yes'); return false
    e.preventDefault();
});
